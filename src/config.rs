...
pub const RENDEZVOUS_SERVERS: &[&str] = &["47.106.147.148"];
pub const RS_PUB_KEY: &str = "q2EZOisHbA5ou2+mJhpEbyFDIkaVRKYa2AvYu2NiT9I=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "http://47.106.147.148:21114/";
